...
#
# SEPETTumorEffectSelfTest
#

class SEPETTumorEffectSelfTest(ScriptedLoadableModule):
...
#
# SEPETTumorEffectSelfTestWidget
#

class SEPETTumorEffectSelfTestWidget(ScriptedLoadableModuleWidget):
  ...
  def onLoadTestData(self):
    tester = SEPETTumorEffectSelfTestTest()
    tester.loadTestData()


#
# SEPETTumorEffectSelfTestLogic
#

class SEPETTumorEffectSelfTestLogic(ScriptedLoadableModuleLogic):
...
class SEPETTumorEffectSelfTestTest(ScriptedLoadableModuleTest):
  """
  ...
  def __init__(self, *args, **kwargs):
    super(SEPETTumorEffectSelfTestTest, self).__init__(*args, **kwargs)
